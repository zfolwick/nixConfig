...
-- keymaps
--- copy markdown to rich text format
vim.keymap.set('n', '<leader>m2r', ':1,/@@@/-1y|!. ~/.bash_aliases && c2r')
--- yank the day
vim.keymap.set('n', '<leader>yd', ':1,/@@@/-1y')
...
local function insert_date()
  -- Move up one line
  vim.cmd('normal! k')
  -- Insert "* Date:" followed by formatted date
  vim.cmd('read !echo "* Date: $(date "+\\%a \\%b \\%d")"')
  vim.cmd('normal! o')
...
vim.keymap.set('n', '<leader>sr', function()
  --- use the insert date snippet above.
  insert_date()
...
-- vim.cmd[[set completeopt+=menuone,noselect,popup]]  -- this makes a shitton of popup text everywhere. can just type C-wd
